/**
 * Constantes de mensajes de error compartidas entre backend y frontend.
 *
 * Fuente única de verdad para textos de error. Electron y src reexportan este módulo.
 * Exporta: GENERAL_ERRORS, API_ERRORS, DOWNLOAD_ERRORS, NETWORK_ERRORS, DATABASE_ERRORS, QUEUE_ERRORS,
 * FILE_ERRORS, WORKER_ERRORS, HISTORY_ERRORS, NAVIGATION_ERRORS, SETTINGS_ERRORS, FAVORITES_ERRORS,
 * FILTERS_ERRORS, APP_ERRORS, OTHER_ERRORS, ERRORS (objeto unificado), ErrorsMap, default.
 *
