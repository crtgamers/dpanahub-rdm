 ...
 *
 * Valores menores = mayor prioridad visual. Exporta: STATE_ORDER, getStateOrder(state).
 *
 * @module shared/constants/queueStateOrder
 */

/** Mapa estado → orden numérico (downloading/starting/merging primero, completed al final). */
