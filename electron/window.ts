 ...
 * @param win - Ventana principal (se ignora si es null o destruida).
 */
...
/**
 * Carga el contenido de la ventana: en desarrollo desde VITE_DEV_SERVER_URL (Vite),
 * en producción desde dist/index.html (loadAppContent).
 * @param win - Ventana en la que cargar el contenido.
 */
 ...
 *
 * @param options - loadContent: si false, la ventana queda vacía (cargar después con loadMainWindowContent).
 * @returns Promesa con la instancia de BrowserWindow creada.
 */
 ...
 * @returns Instancia de BrowserWindow o null si no se ha creado o ya se cerró.
 */
