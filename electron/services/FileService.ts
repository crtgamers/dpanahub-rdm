...
/** Resultado de validación de ruta o nombre de archivo: valid, data normalizada, error. */
...
/** Resultado de getFileCheckInfo: existe, tamaños, similarSize, shouldOverwrite, path, stats. */
...
/** Resultado de buildSavePath: success, savePath, basePath, filename, directory o error. */
...
/** Resultado de prepareDirectory: success, directory, created (si se creó) o error. */
...
export default class FileService extends BaseService {
   ...
   * @returns FileValidationResult (valid, data normalizada) o ServiceResponse.
   */
  ...
  /** Normaliza y resuelve la ruta (path.normalize + path.resolve). Devuelve '' si inválida. */
   ...
   * @returns FileValidationResult (valid, data sanitizada) o ServiceResponse.
   */
   ...
   * Valida basePath y filename antes.
   * @param basePath - Directorio base.
   * @param filename - Nombre del archivo.
   * @param preserveStructure - Si true, incluye relativePath.
   * @param relativePath - Subruta (segmentos validados).
   * @returns BuildSavePathResult o ServiceResponse.
   */
  buildSavePath(
    basePath: string,
    filename: string,
  ...
  /**
   * Crea el directorio si no existe o comprueba que exista y sea escribible.
   * @param directoryPath - Ruta al directorio.
   * @returns PrepareDirectoryResult (success, directory, created?) o ServiceResponse.
   */
  ...
  /**
   * Comprueba si la ruta existe y devuelve stats (isFile, isDirectory, size).
   * @param filePath - Ruta a comprobar.
   * @returns Objeto con exists, isFile, isDirectory, size, path, stats o error.
   */
  ...
  /**
   * Información para decisión de sobrescritura: existe, tamaños, similarSize (según config.files.sizeMarginBytes), shouldOverwrite.
