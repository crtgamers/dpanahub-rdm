...
export default class BaseService {
  ...
  /** @param name - Nombre del servicio (usado para el logger y mensajes). */
  ...
  /** Devuelve ServiceResponse con success: true y data opcional. @param data - Datos a devolver. @param message - Mensaje opcional. */
