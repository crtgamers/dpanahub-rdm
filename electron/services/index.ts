...
/** Inicializa los servicios bajo demanda; idempotente. Usar en handlers IPC antes de getXxxService(). */
export async function ensureServicesInitialized(): Promise<void> {
  if (serviceManager.initialized) return;
