/**
 * Test de calibración de conexión para recomendar max chunks y descargas paralelas.
 *
 * Hace peticiones Range a la URL y prueba distintas combinaciones; devuelve recommendedMaxChunks
 * y recommendedMaxParallel. Expone: ConnectionTestResult, ConnectionTestOptions, runConnectionTest.
 *
...
/** Resultado del test: recomendaciones y mensaje para el usuario. */
...
/** Opciones para runConnectionTest: URL del archivo, tamaño y callback de progreso opcional. */
...
/**
 * Ejecuta el test de conexión: prueba chunks simultáneos y descargas paralelas contra la URL.
 *
 * @param options - url, totalBytes y onProgress opcional (mensaje de estado).
 * @returns ConnectionTestResult con success, recommendedMaxChunks, recommendedMaxParallel, message, details.
 */
