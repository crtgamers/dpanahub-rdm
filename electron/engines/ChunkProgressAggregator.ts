...
/** Entrada de caché por chunk: índice, rango, bytes descargados, estado y hash opcional. */
...
class ChunkProgressAggregator {
   ...
   * @param chunks - Lista de chunks (chunkIndex, startByte, endByte, downloadedBytes?, state).
   */
  init(
    downloadId: number,
