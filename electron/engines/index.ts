/**
 * Punto de entrada del motor de descargas.
 *
 * Exporta por defecto: eventBus, speedTracker, stateStore, circuitBreakerManager, sessionManager,
 * ChunkStore, FileAssembler, Verifier, downloadManager, chunkManager.
 * Exporta namespaces: simpleDownloader, chunkDownloader. Exporta clases y tipos (DownloadState,
 * ChunkState, Scheduler, DownloadValidator, etc.).
 *
 * @module engines
 */
...
export {
  ...
  type SelectDownloadsToStartOptions,
  type SelectDownloadsToStartResult,
} from './QueueProcessor';
...
export { default as DownloadEngine } from './DownloadEngine';
