...
/**
 * Métricas en memoria por sesión (no persiste en DB). Singleton exportado como default.
 * Expone: recordStart, recordBytes, recordCompleted, recordFailed, recordTransientRetry,
 * recordCancelledOrPaused, getGlobalMetrics, getLatencyPercentiles, getHostMetrics, getErrorRate, getHostErrorRate, logSummary, reset.
 */
class DownloadMetrics {
   ...
   * @param host - Hostname de la URL (o null).
   */
   ...
   * @param downloadId - ID de la descarga.
   * @param deltaBytes - Bytes adicionales descargados.
   */
   ...
   * @param downloadId - ID de la descarga.
   * @param totalBytes - Bytes totales (opcional; si no se pasa usa el acumulado del tracker).
   */
   ...
   * @param host - Hostname.
   * @returns Copia de HostMetrics o null.
   */
   ...
   * @param host - Hostname.
   * @returns Cociente errores / (completadas + fallidas); 0 si no hay datos.
   */
