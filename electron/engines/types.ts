...
/** Estados posibles de una descarga en el motor (queued, starting, downloading, paused, merging, verifying, completed, failed, cancelled). */
...
/** Estados posibles de un chunk (pending, downloading, completed, failed, paused). */
