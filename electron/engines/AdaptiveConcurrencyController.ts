...
export class AdaptiveConcurrencyController {
  ...
  /**
   * @param onAdjust - Callback invocado al ajustar concurrencia (concurrent, perHost).
   * @param overrides - Opciones que sobrescriben config.downloads.chunked.adaptiveConcurrencyConfig.
   */
