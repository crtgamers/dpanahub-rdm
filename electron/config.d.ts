/**
 * Tipos para la configuración centralizada del proceso main (config.ts).
 *
 * La implementación y valores por defecto están en config.ts. Algunas claves son
 * Record<string, unknown> por flexibilidad; los valores reales están documentados
 * en config.ts (network, downloads.chunked, rateLimiting, etc.).
 *
 * @module config.d
 */
