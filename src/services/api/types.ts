/**
 * Tipos e interfaces públicos del servicio API (respuestas y parámetros IPC).
 *
 * Expone: APIResponse, DownloadParams, FolderDownloadParams, ConnectionTestData,
 * SuggestedTestFileResponse, CleanHistoryResponse, ApplyDownloadSettingsParams, PathResponse, SearchOptions.
 *
 * @module api/types
 */
