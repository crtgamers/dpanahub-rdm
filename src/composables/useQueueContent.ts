 ...
 *
 * @param options - allDownloads (Ref), showingDownloads (Ref).
 * @returns Retorno de useQueueFilter (queueStateFilter, availableQueueStateFilters, filteredDownloads, etc.).
 */
