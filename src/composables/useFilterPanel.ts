...
/** Opciones: resultados de búsqueda (folders/files), applyFilters y estado de filtros avanzados. */
...
/** Retorno: fuentes filtradas para el panel y flag searchHadResultsButFiltersHideAll. */
...
/**
 * Conecta búsqueda y filtros: aplica applyFilters a searchFolders/searchFiles y mantiene resultados filtrados actualizados.
 *
 * @param options - UseFilterPanelOptions (searchFolders, searchFiles, searchResults, applyFilters, hasActiveFilters, advancedFilters).
 * @returns UseFilterPanelReturn (filterPanelSourceAsFilterable, filteredSearchFolders, filteredSearchFiles, searchHadResultsButFiltersHideAll).
 */
