...
/** Payload de error enviado desde el proceso main (message, type, etc.). */
 ...
 * init() registra el listener; cleanup() lo desregistra. handleMainProcessError muestra toast según tipo de error.
 *
 * @returns init, cleanup, handleMainProcessError.
 */
