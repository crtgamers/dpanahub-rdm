...
/**
 * Composable para handlers de toast en eventos de descarga (download-completed, chunk-failed, download-failed-merge).
 * Registra listeners en mount y los limpia en unmount. No retorna nada; respeta showNotifications de useSettings.
 */
