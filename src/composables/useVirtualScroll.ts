...
/** Rango visible (start, end, total) y timestamp opcional para validación. */
...
/** Ítem con índices _virtualIndex y _actualIndex para el virtual scroll. */
...
/** Opciones: items, containerRef, itemHeight, overscan, minItemsToVirtualize, enabled, useIntersectionObserver. */
...
/** Retorno: scrollTop, visibleRange, visibleItems, spacers, handleScroll, scrollToIndex, observeElement, cleanup, etc. */
