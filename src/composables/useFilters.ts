/**
 * Composable para filtros avanzados en el catálogo (incluir/excluir texto, tags, consolas, cleanOnly, presets).
 *
 * Persiste estado en advancedFilters.json. Expone: advancedFilters, filterPresets, hasActiveFilters,
 * applyFilters (aplica filtros a una lista de ítems), getAvailableTags/getAvailableConsoles,
 * acciones para modificar filtros (addIncludeText, removeExcludeText, selectAllTags, clearAllFilters, etc.)
 * y persistencia de presets (loadFilterPresets, savePreset, loadPreset, deletePreset).
 *
 * @module useFilters
 */
...
/**
 * Composable de filtros avanzados: include/exclude por texto y tags (regions, languages, versions, etc.), consolas, cleanOnly y presets.
 * Persistencia en advancedFilters.json.
 *
 * @returns Objeto con showAdvancedFilters, advancedFilters, filterPresets, currentFilterPreset, tempIncludeText/tempExcludeText,
 *   hasActiveFilters, activeFilterCount, extractTags, classifyTag, applyFilters, getAvailableTags, getAvailableConsoles,
 *   addIncludeText, removeIncludeText, addExcludeText, removeExcludeText, selectAllTags, clearTagCategory,
 *   loadFilterPresets, saveFilterPresets, savePreset, loadPreset, deletePreset, clearAllFilters, resetFiltersOnDatabaseChange, toggleFiltersPanel.
 */
