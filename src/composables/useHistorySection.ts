...
/** Estadísticas de limpieza (timestamps de última limpieza y contadores). */
...
/** Retorno del composable: cleanupStats, handleCleanHistory, handleClearHistory. */
...
/**
 * Composable para sección de historial: limpieza por días, limpieza total, stats y listeners (history-cleaned, memory-cleaned).
 * @returns UseHistorySectionReturn (cleanupStats, handleCleanHistory, handleClearHistory).
 */
export function useHistorySection(): UseHistorySectionReturn {
  ...
  /** Limpia historial por antigüedad (días). Muestra toast de éxito o error y actualiza cleanupStats. */
